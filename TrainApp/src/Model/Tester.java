...
public class Tester {
    ...
    public void inits(){
       ...
       Viaggio w=new Viaggio(t3,linea1,new Date(118,8,2,9,45),Modalita.INVERSA);
       ...
       Viaggio y1=new Viaggio(t3,linea1,new Date(118,8,3,18,00),Modalita.INVERSA);
       ...
       Viaggio wo=new Viaggio(t2,linea1,new Date(118,8,2,15,00),Modalita.INVERSA);
