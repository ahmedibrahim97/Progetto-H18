...
public class Tester {
    ...
    public void inits(){
       ...
       Viaggio v=new Viaggio(t,linea2,new Date(118,8,2,9,00),Modalita.DIRETTA);
       Viaggio w=new Viaggio(t3,linea1,new Date(118,8,10,9,45),Modalita.INVERSA);
       Viaggio y=new Viaggio(t3,linea1,new Date(118,8,2,14,00),Modalita.DIRETTA);
       Viaggio x=new Viaggio(t,linea2,new Date(118,8,2,17,30),Modalita.DIRETTA);
       
       Viaggio v1=new Viaggio(t,linea2,new Date(118,8,3,9,00),Modalita.INVERSA);
       Viaggio w1=new Viaggio(t3,linea1,new Date(118,8,3,10,45),Modalita.DIRETTA);
       Viaggio y1=new Viaggio(t3,linea1,new Date(118,8,10,18,00),Modalita.INVERSA);
       Viaggio x1=new Viaggio(t,linea2,new Date(118,8,3,16,30),Modalita.INVERSA);
        
        
        
       Viaggio vo=new Viaggio(t1,linea2,new Date(118,8,2,18,00),Modalita.DIRETTA);
       Viaggio wo=new Viaggio(t2,linea1,new Date(118,8,10,15,00),Modalita.INVERSA);
       Viaggio vo1=new Viaggio(t1,linea2,new Date(118,8,3,10,00),Modalita.INVERSA);
       Viaggio wo1=new Viaggio(t2,linea1,new Date(118,8,3,15,00),Modalita.DIRETTA);
